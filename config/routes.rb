Spree::Core::Engine.routes.draw do
  ...
  match 'admin/affiliate_settings/update' =>  'admin/affiliate_settings#update', :as => :admin_update_affiliate_settings, via: :post
  ...
  match 'affiliates/request_payment' =>  'affiliates#request_payment', :as => :request_payment, via: :post
